...
export function validateTags(tags:string[]){return tags.map((t,i)=>({index:i,empty:!t.trim(),long:t.length>20,duplicate:!!t&&tags.findIndex(x=>x.trim().toLowerCase()===t.trim().toLowerCase())!==i}))}
